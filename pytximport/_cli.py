...
@click.option(
    "--ignore_transcript_version", is_flag=True, default=True, help="Whether to ignore the transcript version."
)
@click.option(
    "-c",
...
@click.option("-id", "--id_column", help="The column name for the transcript id.")
@click.option("-counts", "--counts_column", help="The column name for the counts.")
@click.option("-length", "--length_column", help="The column name for the length.")
@click.option("-tpm", "--abundance_column", help="The column name for the abundance.")
@click.option("--existence_optional", is_flag=True, help="Whether the existence of the files is optional.")
@click.option("--output_type", type=click.Choice(["xarray", "anndata"]), help="The type of output to return.")
@click.option("--output_format", type=click.Choice(["csv", "h5ad"]), help="The format of the output file.")
def cli(  # type: ignore
    **kwargs,
) -> None:
